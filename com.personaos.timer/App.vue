  ...
  <div class="fill-height pa-8 d-flex flex-column align-center fade-in-up">
    ...
    <div class="max-width-600 w-100">
        <div class="glass-panel pa-6">
            <v-tabs v-model="tab" :color="uiStore.themeColor" align-tabs="center" class="mb-8">
                ...
                <v-window-item value="timer">
                    <div class="d-flex flex-column align-center">
                        ...
                        <div v-if="timerState === 'idle'" class="d-flex gap-2">
                             <v-chip-group v-model="selectedPreset" selected-class="text-primary">
                                <v-chip filter variant="outlined" :value="60">1m</v-chip>
                                <v-chip filter variant="outlined" :value="300">5m</v-chip>
                                <v-chip filter variant="outlined" :value="600">10m</v-chip>
                                <v-chip filter variant="outlined" :value="1500">25m</v-chip>
                            </v-chip-group>
                        </div>
                    </div>
                </v-window-item>
...
function timerFinished() {
    ...
    notificationStore.addNotification({
        ...
        type: 'success',
        duration: 0 // Needs manual dismissal or longer duration
    });
}
